...
app.get('/acadalearning', function(request, response) {
    //response.send("<h2><center>Welcome to Node JS app develpoed by JOMACS-IT</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>Welcome to JOMACS-IT. Please Contact +1584021728 for more information or send an email to info@jomacsit.com <center></h2>" );
    response.end();
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('http://jomacsit.com');
    });
    
 
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/jomacsit");
      })
